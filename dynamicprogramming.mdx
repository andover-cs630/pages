...
<details>
<summary><h3>S.1.1 What is the time complexity for the original recursion? What about the one using DP? Why is the DP one preferable, still?</h3></summary>
...
<details>
<summary><h3>S.1.2 Implement a bottom-up DP algorithm that solves the rod problem.</h3></summary>
