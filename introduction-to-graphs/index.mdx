...
![A network of buildings and roads represented as a network](https://i.ibb.co/YfGMSSC/Real-Network-Frame.png)
[A network of buildings and roads represented as a graph](https://i.ibb.co/yhyxX8t/Graph-Representation-Frame.png)
...
![An unweighted edge and a weighted edge](https://i.ibb.co/QPst8b5/weighted-Edges.png)    
...
![An undirected edge and a directed edge](https://i.ibb.co/fpKmW34/directed-Edges.png)
...
![A directed, unweighted graph with four nodes](https://i.ibb.co/qJFsTPw/Adjacency-Graph.png)
